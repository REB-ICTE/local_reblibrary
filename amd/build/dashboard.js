define(["exports","./assets/styles-B6ctzqiv","./assets/resources-DcBbVI18","./assets/signals.module-Cf4Jui3n","./assets/library-menu-bemaxSAd"],(function(i,e,m,s,d){"use strict";function l({icon:a,number:r,label:o}){return e.u("div",{className:"bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6 text-center",children:[e.u("div",{className:"text-4xl text-reb-blue mb-4",children:e.u("i",{className:a})}),e.u("h3",{className:"text-3xl font-bold text-reb-blue mb-2",children:r}),e.u("p",{className:"text-sm text-gray-600",children:o})]})}/**
